fn main() {
    ...
    if cfg!(feature = "emulator") {
        ...
        lib.add_public_define("KERNEL", None); // !@# temp hack for including applet.h

        lib.add_public_define("PYOPT", Some("0")); // !@# gate with "debug" feature, move to upymod, remove from syscalls/smcalls
